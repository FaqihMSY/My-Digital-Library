export default {
  ...
  themeConfig: {
    nav: [
      ...
      {
        text: "GitHub",
        link: "https://github.com/FaqihMSY/My-Digital-Library",
      },
    ],
    sidebar: [
      {
          ...
          { text: "Introduction", link: "/git/introduction" },
          {
            ...
            items: [
              { text: "Overview", link: "/git/basic-commands" },
              {
                ...
                link: "/git/staging-and-committing",
              },
            ],
          },
        ],
        ...
        items: [
          {
            ...
            link: "/system-database/introduction",
          },
          {
            text: "Perfomance Tuning",
            link: "/system-database/performance-tuning",
          },
          {
            text: "Storage and File Structure",
            link: "/system-database/storage-and-file",
          },
          { text: "Indexing", link: "/system-database/indexing" },
          {
            text: "Schema and Index Tuning",
            link: "/system-database/schema-index-tuning",
          },
          {
            text: "Query Processing",
            link: "/system-database/query-processing",
          },
          {
